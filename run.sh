...
CHECKPOINT_PATH="./checkpoints/CRNN_Conditioning_regressedLoss.pth"

# For reading data and extracting features
...
# evaluating model
#python3 src/results.py calculate_metrics --workspace=$WORKSPACE --model_type='CRNN_Conditioning' --dataset='maps' --split='test' --post_processor_type='regression' 

...
from keras.layers import Conv1D, MaxPooling1D, UpSampling2D, UpSampling1D,Conv2D,Conv2DTranspose,MaxPooling2D,Cropping2D
...
def seg(feature_num=128,
    ...
    layer_out = []
    print(timesteps, feature_num, ch_num)

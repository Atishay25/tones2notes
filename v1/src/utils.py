...
from src.models.mymodel import seg
#from src.models import model_attn
from src.config import get_MusicNet_label_num_mapping, get_instruments_num, MusicNet_Instruments
...
class ModelInfo:
    ...
    def load_model(self, model_path):
        ...
        model = model_from_json(
            open(os.path.join(model_path, "arch.json")).read(), 
